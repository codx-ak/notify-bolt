export const propsList = [
  ...
  {
    name: "variant",
    types: ["classic", "minimal", "default"],
    default: `"classic"`,
    description:
      "Sets the modal's layout style. 'Classic' for traditional, 'Minimal' for a simpler appearance.",
    examples: [`showNotify({ variant: "minimal" });`],
  },
  {
    name: "size",
    types: ["xs", "sm", "md", "lg"],
  ...
  },
  {
    ...
    default: `"status"`,
    description:
      "Custom icon for the modal. Accepts emoji strings, custom React elements, or defaults based on the status.",
    examples: [
      `showNotify({ icon: "🔥" });`,
      `showNotify({ icon: <CustomIcon /> });`,
      `showNotify({ icon: "success" });`,
    ],
  },
  {
    name: "iconType",
